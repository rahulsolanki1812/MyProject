...
function playVideo(videoId) {
    var template = "<iframe src='https://www.youtube.com/embed/"+videoId+"'  width='773' height='435'  frameborder='0' allow='autoplay; encrypted-media' allowfullscreen></iframe>";
    window.onscroll = "";
    var state= {data: template};
    document.getElementById('video-container').innerHTML = template;
    history.pushState(state,"Playing","video.html");
}
